  ...
  <div>
    ...
    <el-card class="box-card">
      ...
      >
        ...
        <el-table-column prop="deviceNumber" label="设备号码" min-width="110"></el-table-column>
        <el-table-column prop="siloNumber" label="井号：" min-width="110"></el-table-column>
        <el-table-column prop="address" label="地址" min-width="110"></el-table-column>

        <el-table-column prop="name" label="管理员姓名" min-width="110"></el-table-column>
        <el-table-column prop="telephone" label="通知电话" min-width="110"></el-table-column>
         <el-table-column label="最后上交时间" min-width="110">
